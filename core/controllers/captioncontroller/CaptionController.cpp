...
int CaptionController::height() const
{
...
bool CaptionController::isIgnorable(QQuickItem *i)
{
    if (!i)
        return true;
...
bool CaptionController::isInteractive(QQuickItem *i)
{
    if (!i)
        return false;
...
QQuickItem* CaptionController::findInteractiveAt(QQuickItem *parent,
